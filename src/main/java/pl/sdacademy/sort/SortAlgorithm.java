 ...
 * 
 * int n = array.length; /* i-zmienna licznikowa pętli umieszczającej kolejne
 * elementy zbioru w kopcu, i -> Naturalne, i -> {2,3,...,n} j,k - indeksy
 * elementów leżących na ścieżce od wstawianego elementu do korzenia, j,k->
 * Całkowite tmp - zmienna pomocnicza przechowująca tymczasowo element wstawiany
 * do kopca
 */
// int i, j, k, tmp;
// // Kopiec - montaż
